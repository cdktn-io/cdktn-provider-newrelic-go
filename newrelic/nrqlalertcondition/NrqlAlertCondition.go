...
func (n *jsiiProxy_NrqlAlertCondition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (n *jsiiProxy_NrqlAlertCondition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
