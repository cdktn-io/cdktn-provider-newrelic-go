...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/alertpolicy/internal"
...
func (j *jsiiProxy_AlertPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AlertPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AlertPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AlertPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewAlertPolicy(scope constructs.Construct, id *string, config *AlertPolicyConfig) AlertPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-newrelic.alertPolicy.AlertPolicy",
...
func (j *jsiiProxy_AlertPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AlertPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AlertPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AlertPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AlertPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AlertPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AlertPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AlertPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AlertPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
