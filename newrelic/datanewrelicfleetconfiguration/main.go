...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataNewrelicFleetConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "latestVersionEntityId", GoGetter: "LatestVersionEntityId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVersionEntityId", GoMethod: "ResetVersionEntityId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "versionEntityIdInput", GoGetter: "VersionEntityIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-newrelic.dataNewrelicFleetConfiguration.DataNewrelicFleetConfigurationConfig",
		reflect.TypeOf((*DataNewrelicFleetConfigurationConfig)(nil)).Elem(),
	)
}
