...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FleetConfiguration)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "managedEntityType", GoGetter: "ManagedEntityType"},
			_jsii_.MemberProperty{JsiiProperty: "managedEntityTypeInput", GoGetter: "ManagedEntityTypeInput"},
