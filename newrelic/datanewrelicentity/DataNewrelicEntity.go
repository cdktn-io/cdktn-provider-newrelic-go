...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.80.3/docs/data-sources/entity newrelic_entity} Data Source.
...
func (d *jsiiProxy_DataNewrelicEntity) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
