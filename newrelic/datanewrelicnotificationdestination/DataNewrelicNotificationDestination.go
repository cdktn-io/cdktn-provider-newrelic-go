...
type DataNewrelicNotificationDestination interface {
	...
	ScopeInput() *DataNewrelicNotificationDestinationScope
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) Active() cdktn.IResolvable {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) Scope() DataNewrelicNotificationDestinationScopeOutputReference {
	var returns DataNewrelicNotificationDestinationScopeOutputReference
	_jsii_.Get(
		j,
		"scope",
		&returns,
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) ScopeInput() *DataNewrelicNotificationDestinationScope {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs/data-sources/notification_destination newrelic_notification_destination} Data Source.
func NewDataNewrelicNotificationDestination(scope constructs.Construct, id *string, config *DataNewrelicNotificationDestinationConfig) DataNewrelicNotificationDestination {
	...
	_jsii_.Create(
		"@cdktn/provider-newrelic.dataNewrelicNotificationDestination.DataNewrelicNotificationDestination",
...
func (j *jsiiProxy_DataNewrelicNotificationDestination)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataNewrelicNotificationDestination)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataNewrelicNotificationDestination)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataNewrelicNotificationDestination_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataNewrelicNotificationDestination) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataNewrelicNotificationDestination) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataNewrelicNotificationDestination) PutScope(value *DataNewrelicNotificationDestinationScope) {
...
func (d *jsiiProxy_DataNewrelicNotificationDestination) ResetScope() {
	_jsii_.InvokeVoid(
		d,
		"resetScope",
		nil, // no parameters
