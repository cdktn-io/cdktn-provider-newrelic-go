...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/syntheticsmonitor/internal"
...
func (j *jsiiProxy_SyntheticsMonitor) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_SyntheticsMonitor) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_SyntheticsMonitor) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SyntheticsMonitor) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_SyntheticsMonitor) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.1/docs/resources/synthetics_monitor newrelic_synthetics_monitor} Resource.
...
func (j *jsiiProxy_SyntheticsMonitor)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_SyntheticsMonitor)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_SyntheticsMonitor)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func SyntheticsMonitor_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SyntheticsMonitor) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsMonitor) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_SyntheticsMonitor) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsMonitor) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SyntheticsMonitor) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_SyntheticsMonitor) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
