...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/alertcondition/internal"
...
func (j *jsiiProxy_AlertCondition) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_AlertCondition) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_AlertCondition) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_AlertCondition) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_AlertCondition) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewAlertCondition(scope constructs.Construct, id *string, config *AlertConditionConfig) AlertCondition {
	...
	_jsii_.Create(
		"@cdktn/provider-newrelic.alertCondition.AlertCondition",
...
func (j *jsiiProxy_AlertCondition)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_AlertCondition)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_AlertCondition)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func AlertCondition_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_AlertCondition) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AlertCondition) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (a *jsiiProxy_AlertCondition) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_AlertCondition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AlertCondition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AlertCondition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
