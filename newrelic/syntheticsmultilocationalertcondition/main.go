...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-newrelic.syntheticsMultilocationAlertCondition.SyntheticsMultilocationAlertConditionConfig",
		reflect.TypeOf((*SyntheticsMultilocationAlertConditionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-newrelic.syntheticsMultilocationAlertCondition.SyntheticsMultilocationAlertConditionCritical",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-newrelic.syntheticsMultilocationAlertCondition.SyntheticsMultilocationAlertConditionWarning",
