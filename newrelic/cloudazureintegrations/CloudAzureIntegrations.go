...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.4/docs/resources/cloud_azure_integrations newrelic_cloud_azure_integrations} Resource.
...
func (c *jsiiProxy_CloudAzureIntegrations) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudAzureIntegrations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudAzureIntegrations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
