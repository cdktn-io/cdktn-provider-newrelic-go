...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/provider/internal"
...
func (n *jsiiProxy_NewrelicProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
