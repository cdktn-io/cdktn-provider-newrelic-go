...
func (j *jsiiProxy_WorkflowEnrichmentsNrqlConfigurationList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWorkflowEnrichmentsNrqlConfigurationList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WorkflowEnrichmentsNrqlConfigurationList {
	_init_.Initialize()
...
func NewWorkflowEnrichmentsNrqlConfigurationList_Override(w WorkflowEnrichmentsNrqlConfigurationList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkflowEnrichmentsNrqlConfigurationList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkflowEnrichmentsNrqlConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkflowEnrichmentsNrqlConfigurationList) Resolve(context cdktn.IResolveContext) interface{} {
