...
func (j *jsiiProxy_WorkflowIssuesFilterPredicateList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewWorkflowIssuesFilterPredicateList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WorkflowIssuesFilterPredicateList {
	_init_.Initialize()
...
func NewWorkflowIssuesFilterPredicateList_Override(w WorkflowIssuesFilterPredicateList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_WorkflowIssuesFilterPredicateList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (w *jsiiProxy_WorkflowIssuesFilterPredicateList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WorkflowIssuesFilterPredicateList) Resolve(context cdktn.IResolveContext) interface{} {
