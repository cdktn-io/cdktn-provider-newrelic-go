...
func (j *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewSyntheticsStepMonitorStepsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SyntheticsStepMonitorStepsOutputReference {
	_init_.Initialize()
...
func NewSyntheticsStepMonitorStepsOutputReference_Override(s SyntheticsStepMonitorStepsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SyntheticsStepMonitorStepsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_SyntheticsStepMonitorStepsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
