...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.99.3/docs/resources/cloud_gcp_integrations newrelic_cloud_gcp_integrations} Resource.
...
func (c *jsiiProxy_CloudGcpIntegrations) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudGcpIntegrations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudGcpIntegrations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
