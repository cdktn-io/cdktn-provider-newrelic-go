...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/cloudocilinkaccount/internal"
...
func (c *jsiiProxy_CloudOciLinkAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudOciLinkAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
