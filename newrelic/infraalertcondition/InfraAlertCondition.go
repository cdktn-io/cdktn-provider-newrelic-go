...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/infra_alert_condition newrelic_infra_alert_condition} Resource.
...
func (i *jsiiProxy_InfraAlertCondition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_InfraAlertCondition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_InfraAlertCondition) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
