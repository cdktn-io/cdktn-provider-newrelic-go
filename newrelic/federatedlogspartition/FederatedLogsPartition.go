...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.99.3/docs/resources/federated_logs_partition newrelic_federated_logs_partition} Resource.
...
func (f *jsiiProxy_FederatedLogsPartition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (f *jsiiProxy_FederatedLogsPartition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
