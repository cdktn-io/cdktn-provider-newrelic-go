...
func (a *jsiiProxy_AlertMutingRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AlertMutingRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
