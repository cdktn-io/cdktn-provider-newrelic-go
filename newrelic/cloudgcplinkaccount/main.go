...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUseWorkloadIdentityFederation", GoMethod: "ResetUseWorkloadIdentityFederation"},
			...
			_jsii_.MemberProperty{JsiiProperty: "useWorkloadIdentityFederation", GoGetter: "UseWorkloadIdentityFederation"},
			_jsii_.MemberProperty{JsiiProperty: "useWorkloadIdentityFederationInput", GoGetter: "UseWorkloadIdentityFederationInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-newrelic.cloudGcpLinkAccount.CloudGcpLinkAccountConfig",
