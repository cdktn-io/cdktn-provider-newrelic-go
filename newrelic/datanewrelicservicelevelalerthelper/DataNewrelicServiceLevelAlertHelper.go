...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/datanewrelicservicelevelalerthelper/internal"
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.98.0/docs/data-sources/service_level_alert_helper newrelic_service_level_alert_helper} Data Source.
...
func (d *jsiiProxy_DataNewrelicServiceLevelAlertHelper) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataNewrelicServiceLevelAlertHelper) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
