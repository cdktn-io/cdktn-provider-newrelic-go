...
func (j *jsiiProxy_Workload) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Workload) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Workload) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Workload) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Workload) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.4/docs/resources/workload newrelic_workload} Resource.
...
func (j *jsiiProxy_Workload)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Workload)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Workload)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Workload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (w *jsiiProxy_Workload) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Workload) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (w *jsiiProxy_Workload) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (w *jsiiProxy_Workload) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (w *jsiiProxy_Workload) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
