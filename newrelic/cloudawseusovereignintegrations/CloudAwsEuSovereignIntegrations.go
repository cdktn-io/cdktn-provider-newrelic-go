...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.99.3/docs/resources/cloud_aws_eu_sovereign_integrations newrelic_cloud_aws_eu_sovereign_integrations} Resource.
...
func (c *jsiiProxy_CloudAwsEuSovereignIntegrations) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudAwsEuSovereignIntegrations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudAwsEuSovereignIntegrations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
