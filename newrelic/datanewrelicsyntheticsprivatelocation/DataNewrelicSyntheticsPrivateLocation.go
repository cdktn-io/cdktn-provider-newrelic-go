...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/datanewrelicsyntheticsprivatelocation/internal"
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataNewrelicSyntheticsPrivateLocation(scope constructs.Construct, id *string, config *DataNewrelicSyntheticsPrivateLocationConfig) DataNewrelicSyntheticsPrivateLocation {
	...
	_jsii_.Create(
		"@cdktn/provider-newrelic.dataNewrelicSyntheticsPrivateLocation.DataNewrelicSyntheticsPrivateLocation",
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataNewrelicSyntheticsPrivateLocation)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataNewrelicSyntheticsPrivateLocation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataNewrelicSyntheticsPrivateLocation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
