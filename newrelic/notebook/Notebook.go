...
type Notebook interface {
	...
	PutTimeouts(value *NotebookTimeouts)
...
func (j *jsiiProxy_Notebook) BlobId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"blobId",
...
func (j *jsiiProxy_Notebook) Content() *string {
	var returns *string
	_jsii_.Get(
		j,
		"content",
...
func (j *jsiiProxy_Notebook) ContentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"contentInput",
...
func (j *jsiiProxy_Notebook) Guid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"guid",
...
func (j *jsiiProxy_Notebook) OrganizationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationId",
...
func (j *jsiiProxy_Notebook) Timeouts() NotebookTimeoutsOutputReference {
	var returns NotebookTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_Notebook) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_Notebook) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_Notebook) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
// Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.99.1/docs/resources/notebook newrelic_notebook} Resource.
func NewNotebook(scope constructs.Construct, id *string, config *NotebookConfig) Notebook {
	...
	_jsii_.Create(
		"@cdktn/provider-newrelic.notebook.Notebook",
...
func (j *jsiiProxy_Notebook)SetContent(val *string) {
...
func (j *jsiiProxy_Notebook)SetTitle(val *string) {
...
func (n *jsiiProxy_Notebook) PutTimeouts(value *NotebookTimeouts) {
...
func (n *jsiiProxy_Notebook) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
