...
func (c *jsiiProxy_CloudAwsIntegrations) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudAwsIntegrations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudAwsIntegrations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
