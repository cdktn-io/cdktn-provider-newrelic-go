...
func (n *jsiiProxy_NotificationDestination) validatePutAuthCustomHeaderParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NotificationDestinationAuthCustomHeader; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NotificationDestination) validatePutPropertyParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*NotificationDestinationProperty; received %#v (a %T)", value, value)
		}
	}
