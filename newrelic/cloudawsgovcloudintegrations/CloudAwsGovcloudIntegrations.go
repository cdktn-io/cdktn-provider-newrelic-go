...
func (c *jsiiProxy_CloudAwsGovcloudIntegrations) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrations) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudAwsGovcloudIntegrations) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
