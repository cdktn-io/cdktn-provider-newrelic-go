...
func (s *jsiiProxy_SyntheticsSecureCredential) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_SyntheticsSecureCredential) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
