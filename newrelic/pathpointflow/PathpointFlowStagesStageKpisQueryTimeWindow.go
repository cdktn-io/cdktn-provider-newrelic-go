...
type PathpointFlowStagesStageKpisQueryTimeWindow struct {
	...
	RelativeRange *PathpointFlowStagesStageKpisQueryTimeWindowRelativeRange `field:"optional" json:"relativeRange" yaml:"relativeRange"`
}
