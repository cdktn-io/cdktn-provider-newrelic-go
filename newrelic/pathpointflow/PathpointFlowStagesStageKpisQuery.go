...
type PathpointFlowStagesStageKpisQuery struct {
	...
	Select *PathpointFlowStagesStageKpisQuerySelect `field:"required" json:"select" yaml:"select"`
	// time_window block.
	//
	...
	TimeWindow *PathpointFlowStagesStageKpisQueryTimeWindow `field:"optional" json:"timeWindow" yaml:"timeWindow"`
