...
func (a *jsiiProxy_AlertCompoundCondition) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (a *jsiiProxy_AlertCompoundCondition) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
