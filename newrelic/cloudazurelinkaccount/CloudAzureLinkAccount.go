...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/cloudazurelinkaccount/internal"
...
func (c *jsiiProxy_CloudAzureLinkAccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_CloudAzureLinkAccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_CloudAzureLinkAccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
