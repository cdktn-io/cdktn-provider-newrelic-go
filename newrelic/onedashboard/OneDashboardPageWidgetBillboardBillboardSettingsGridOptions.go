...
type OneDashboardPageWidgetBillboardBillboardSettingsGridOptions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/one_dashboard#columns OneDashboard#columns}
	Columns *float64 `field:"optional" json:"columns" yaml:"columns"`
	// Grid label setting.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/one_dashboard#label OneDashboard#label}
