...
func (a *jsiiProxy_ApplicationSettings) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (a *jsiiProxy_ApplicationSettings) validatePutErrorCollectorParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ApplicationSettingsErrorCollector; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_ApplicationSettings) validatePutTransactionTracerParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*ApplicationSettingsTransactionTracer; received %#v (a %T)", value, value)
		}
	}
...
func (a *jsiiProxy_ApplicationSettings) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_ApplicationSettings) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
