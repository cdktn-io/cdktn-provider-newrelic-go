...
import (
	...
	"github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v15/applicationsettings/internal"
...
func (j *jsiiProxy_ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewApplicationSettingsTransactionTracerExplainQueryPlansOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference {
	_init_.Initialize()
...
func NewApplicationSettingsTransactionTracerExplainQueryPlansOutputReference_Override(a ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (a *jsiiProxy_ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (a *jsiiProxy_ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (a *jsiiProxy_ApplicationSettingsTransactionTracerExplainQueryPlansOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
