...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataNewrelicApiAccessKey)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-newrelic.dataNewrelicApiAccessKey.DataNewrelicApiAccessKeyConfig",
		reflect.TypeOf((*DataNewrelicApiAccessKeyConfig)(nil)).Elem(),
	)
}
